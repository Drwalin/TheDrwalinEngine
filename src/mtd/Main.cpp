...
int main()
{
	...
	map->SetModel( mdl );
	for( int i = 0; i < 10; ++i )
		engine->AddBox( engine->GetAvailableObjectName("Box"), btVector3(0.5,0.5,0.5), btTransform( btQuaternion(btVector3(1,1,1),0), btVector3(0,20,0) + btVector3((i/7)%7,i/49,i%7) - btVector3(2.5,2.5,2.5) ), true, 200.0 )->SetModel( crate01 );
